 ...
 * @author max
 */
@WebServlet(name = "GetLoginState", urlPatterns =
{
    "/getloginstate"
})
public class GetLoginState extends HttpServlet
{
    private static final Logger log = LoggerFactory.getLogger(GetLoginState.class);
